// ── SWIPE NAVIGATION ──────────────────────────────────────────────────────────
// Horizontal swipe gesture navigates between chapters, or between tabs when
// a tabbed page (Settings, How To) is open. The gesture is ignored on answer
// fields so the user can scroll inside textareas without triggering navigation.
//
// Also contains the scroll and visibilitychange listeners that keep the last
// reading position in sync.
//
// Dependencies (all available as globals before this file loads):
//   appSettings          – settings.js
//   getSwipeThreshold    – settings.js
//   chapters, currentChapter, isNonChapterPage – main.js STATE section
